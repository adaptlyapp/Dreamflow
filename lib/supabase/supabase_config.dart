...
class SupabaseConfig {
  static const String supabaseUrl = 'https://jcxylxmmbstfwiwexovy.supabase.co';
  static const String anonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpjeHlseG1tYnN0Zndpd2V4b3Z5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjgxMDgzMzYsImV4cCI6MjA4MzY4NDMzNn0.LdCAKkNDTdd9gXz5ubAOOTHWjeRoOZXQ8feSQkuMQDU';
  
  /// Deep link scheme for password reset and OAuth callbacks from email
  /// Format: com.Adaptly.app://auth/reset-password
  static const String deepLinkScheme = 'com.Adaptly.app';
  ...
  static Future<void> initialize() async {
    await Supabase.initialize(
      ...
      authOptions: FlutterAuthClientOptions(
        ...
        detectSessionInUri: true, // Automatically detect OAuth callbacks in deep links
        // This tells Supabase where to redirect after email confirmation
        // For web builds, this should be your production URL
        // For mobile, this uses the deep link scheme defined above
      ),
    );
