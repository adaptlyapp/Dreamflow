...
--
-- This file exists because the remote deploy runner is applying a migration with the
-- exact name `20260915194326_dreamflow_generated.sql` and failing with:
...
-- table. SQL-language functions validate referenced columns at CREATE time.
