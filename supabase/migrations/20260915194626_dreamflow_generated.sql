...
--
-- The remote deploy runner is applying a migration with the exact name:
--   20260915194626_dreamflow_generated.sql
--
...
--
-- Root cause:
-- Some linked Supabase projects already have a legacy `public.resources_curated`
